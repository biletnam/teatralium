...
const url = "https://teatralium.com/articles/idite_na/e";
  ...
  <Bg bg="rgba(255,0,0,0.2)">
    <StyledFillCover contain pathname={props.pathname} sizes={sizes} {...props}>
      <Section margin="0" align="left" color="white" size="1.5rem">
        <StyledH1 lineHeight="1.2" size="2rem">Идите на «Любимовку»</StyledH1>
        <hr />
        Кажется, вы еще не отдохнули от актер-актерычей в спектаклях-спекталичах, поэтому лучшим вариантом для вас станет фестиваль новой драмы «Любимовка». Целая неделя читок <A href="http://lubimovka.ru/lyubimovka-god" target="_blank">самых свежих пьес</A> и их обсуждений с последующим распитием пива с драматургами.
        <hr />
        <div>
...
query IditeNaEImageQuery {
  cover: imageSharp(id: { regex: "/idite_na/e-cover.jpg/" }) {
    sizes(maxWidth: 1200) {
        ...GatsbyImageSharpSizes
    }
  }
  bg: imageSharp(id: { regex: "/idite_na/e.jpg/" }) {
    sizes(maxWidth: 1200) {
        ...GatsbyImageSharpSizes
    }
  }
