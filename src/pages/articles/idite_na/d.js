...
const url = "https://teatralium.com/articles/idite_na/d";
  ...
  <Bg bg="rgba(255,0,0,0.2)">
    <StyledFillCover contain pathname={props.pathname} sizes={sizes} {...props}>
      <Section margin="0" align="left" color="white" size="1.5rem">
        <StyledH1 lineHeight="1.2" size="2rem">Идите на «Трех сестер» Женовача</StyledH1>
        <hr />
        Все будет так, как вы любите: оденетесь покрасивше, к семи приедете в театр, сядете в кресло и будете три часа следить, как <A href="https://sti.ru/tri-sestry/" target="_blank">«Три сестры»</A> рвутся в Москву, в Москву. Никаких сюрпризов и голых жоп. Скучно, но вас тоже можно понять.
        <hr />
        <div>
...
query IditeNaDImageQuery {
  cover: imageSharp(id: { regex: "/idite_na/d-cover.jpg/" }) {
    sizes(maxWidth: 1200) {
        ...GatsbyImageSharpSizes
    }
  }
  bg: imageSharp(id: { regex: "/idite_na/d.jpg/" }) {
    sizes(maxWidth: 1200) {
        ...GatsbyImageSharpSizes
    }
  }
