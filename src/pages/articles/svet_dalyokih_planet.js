...
import a1 from '../images/svet_dalyokih_planet/1.jpg'
import a2 from '../images/svet_dalyokih_planet/2.jpg'
import a3 from '../images/svet_dalyokih_planet/3.jpg'
import a4 from '../images/svet_dalyokih_planet/4.jpg'
import a5 from '../images/svet_dalyokih_planet/5.jpg'
import a6 from '../images/svet_dalyokih_planet/6.jpg'
import a7 from '../images/svet_dalyokih_planet/7.jpg'
import a8 from '../images/svet_dalyokih_planet/8.jpg'
import a9 from '../images/svet_dalyokih_planet/9.jpg'
    ...
    return (
      <div>
        <ArticleHelmet
          ...
          title="Свет далеких планет: обзор европейских премьер нового сезона | Театралий"
        />
        <Section>
          ...
          <Small>фото: rundfunkchor-berlin.de</Small>
          ...
          <H4 marginTop="3rem">Théâtre de Liège, Льеж</H4>
          <Img marginTop="2rem" marginBottom="1em" src={a5} />
          <Small>«Les Parisiens», фото: theatredeliege.be</Small>
          <p>А если кому-то мало двух Оливье Пи, то вот еще, пожалуйста, и третий: спектакль по его собственному роману <a target="_blank" href="http://theatredeliege.be/evenement/les-parisiens/">«Парижане»</a>. Премьера уже прошла на Авиньонском фестивале в этом году, но в Льеже спектакль можно будет увидеть в сентябре.</p>
          ...
          <p>Четыре с половиной часа Кшиштофа Варликовского — вот что в октябре и ноябре предлагает парижская опера. Режиссер, имя которого олицетворяет большую часть современного польского театра, в Париже ставит <a target="_blank" href="https://www.operadeparis.fr/en/season-17-18/opera/don-carlos">«Дона Карлоса»</a> Верди. Ознакомившись с доступными к просмотру оперными спектаклями Варликовского (<a target="_blank" href="https://vk.com/video-129481581_456239200">«Женщина без тени»</a>, <a target="_blank" href="https://vk.com/video-129481581_456239112">«Замок герцога Синяя Борода»/«Голос человека»</a>, <a target="_blank" href="https://vk.com/video-129481581_456239093">«Медея»</a>, <a target="_blank" href="https://vk.com/video-129481581_456239223">«Меченые»</a>), можно понять, что это must-see.</p>
          <p>Кроме того, режиссер Иво ван Хове, уже знаменитый своими эпическими интерпретациями политическим драм, ставит свой первый спектакль в Парижской опере — <a target="_blank" href="https://www.operadeparis.fr/en/season-17-18/opera/boris-godounov">«Бориса Годунова»</a> Мусоргского. Владимир Юровский в качестве дирижера, видимо, призван добавить в постановку немножко русскости. </p>
