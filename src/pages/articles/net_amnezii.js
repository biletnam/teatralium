    ...
    return (
      <div>
        ...
        <Img
          ...
          maxWidth="800px"
          noBorder
          desc="Учить наизусть по-португальски будет aprenda de cor, а украшать —
        ...
        <Img
          ...
          maxWidth="800px"
          noBorder
          desc="Одна из героинь истории Родригеса — Надежда Мандельштам, которая сохранила наследие мужа, выучив его стихотворения в разных версиях."
        />
        ...
        <Img
          ...
          maxWidth="800px"
          noBorder
          desc="Родригес также рассказывает о раввине, знавшем Тору наизусть. Во время Холокоста он звал верующих к себе, чтобы те читали его как книгу."
        />
        <TopCover>
          <Section margin="0">
        ...
        <Img
          ...
          maxWidth="800px"
          noBorder
          desc="В конце спектакля, когда сонет выучен и прочитан, десять зрителей получают его текст, напечатанный на тонком тесте. Выучить наизусть — то есть буквально съесть, проглотить, впустить внутрь физически."
        />
        ...
        <Small outside>
          ...
          стихотворение и передадут его дальше, стихотворение не пропадет. То же
          происходит и с книгами в романе Брэдбери «451° по Фаренгейту», который
          также упоминается Родригесом. Так случилось и с бабушкой Родригеса
          Кандидой — главной героиней спектакля. Начав терять зрение, она
          попросила внука выбрать книгу, которую она могла бы выучить наизусть,
          чтобы обращаться к ней, когда читать будет уже невозможно. Этой книгой
          и стал сборник сонетов Шекспира. Однажды Родригес приехал к бабушке в
