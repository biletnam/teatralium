...
const title = 'Непереводимый русский надрыв: Юрий Муравицкий и Валерий Печейкин о любви и хаосе'
    ...
    return (
      <div>
        ...
        <Section>
          ...
          <Gallery images={images} desc="«Вижу тебя, знаю тебя», фото: Екатерина Краева" />
