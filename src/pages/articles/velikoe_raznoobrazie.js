...
const title = 'Великое разнообразие: Марина Давыдова о том, что нужно знать о современном театре'
  ...
  render() {
    return (
      <div>
        ...
        />
        <Section>
          <Date>21 ноября 2017, текст:&nbsp;<b>Театралий</b></Date>
          <H1 center>Великое разнообразие</H1>
          <H1small center>Марина Давыдова о том, что нужно знать о современном театре</H1small>
          <NoteWrapper>
            <P>Бывает сложно объяснить, зачем театральные режиссеры делают проекты на заводах или в квартирах и почему группа людей, гуляющая в наушниках по городу, смотрит именно спектакль, а не участвует, скажем, в квесте. О важных тенденциях и именах в современном театре, а также о том, откуда взялась та самая иммерсивность, о которой уже, слава богу, не так много говорят, в своей лекции рассказала театральный критик, куратор, а теперь и режиссер Марина Давыдова, а «Театралий» записал основные тезисы.</P>
            <Note top="0px">Лекция «Границы театра в условиях современности» была прочитана в <a href="http://www.ncca.ru/events.text?filial=2&id=3855&date=1.12.2016">ГЦСИ</a> в рамках исследовательского проекта «Контексты перформативности».</Note>
          </NoteWrapper>
          </Section>
