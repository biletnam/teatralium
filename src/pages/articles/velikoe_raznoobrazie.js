  ...
  render() {
    return (
      <div>
        ...
        />
        <Section>
          <Date>23 октября 2017, текст:&nbsp;<b>Театралий</b></Date>
          ...
          <Video id="afXzOyECw24" />
          <p>«Disabled Theatre» — социальный проект Жерома Беля, в котором, как это описывается, disabled disadvantaged people были главными героями спектакля. Они никого не играли. Просто каждый выходил на сцену, говорил: «Меня Жером Бель просил представиться»,  потом рассказывал, что с ним не так. Потом танцевал.</p>
