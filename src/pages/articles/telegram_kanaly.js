...
const url = "https://teatralium.com/articles/telegram_kanaly/";
const title =
  "«Зачем-то мне это надо»: кто ведет театральные блоги и может ли телеграм-канал о театре быть популярным";
...
export const TelegramCover = ({ sizes, showDate = true, ...props }) => (
  ...
  >
    <Section margin="0" align={props.align || "center"}>
      ...
      {showDate && (
        <StyledDate>
          29 июля 2018, текст:&nbsp;<b>Настя Николаева</b>
        </StyledDate>
      )}
    </Section>
  </TopCover>
    ...
    return (
      <div>
        <ArticleHelmet
          ...
          description="Вилисов постдраматический, а театр постиронический."
          title={`${title} | Театралий`}
        />
        <TelegramCover sizes={data.cover.sizes} />
        <Section withHomepageLink>
          <P>
            Система отношений между людьми, которые делают театр и которые об этом пишут, наглядно представлена в фейсбуке. Участники обеих сторон театрального процесса поделены на своих и чужих, то есть если критик пишет о спектакле, то, вероятнее всего, его поставил «свой» режиссер, оценка будет положительной и под постом об этом соберется энное количество восторженных комментариев своих же. Неудивительно, что в эту кастовую систему никто особенно не хочет включать блогеров, не преследующих {" "}
            <a href="http://prozhito.org/person/1547">
              древнюю цель студентов театроведческих факультетов
            </a>{" "} попасть в тусовку режиссеров и директоров. Восемь авторов театральных телеграм-каналов по&#8209;разному добиваются слома этой традиции. Как — и зачем им это надо?
          </P>


          <H1Styled>«вилисов постдраматический»</H1Styled>
          <H1smallStyled><a href="https://telegram.dog/apollonia/">t.me/apollonia</a></H1smallStyled>
          <Img
            noBorder
            sizes={data.img1.sizes}
            maxWidth="100%"
            desc="Yuichi Inoue, «Yume»" />

          <List>
            <li>
              <b>Автор: </b>Виктор Вилисов
            </li>
            <li>
              <b>Дата создания: </b>май 2016 года
            </li>
            <li>
              <b>Количество подписчиков: </b>4273
           </li>
          </List>

          <H1smallStyled>«Кто&#8209;то заимствовал язык Вилисова, и читается это местами жутко»</H1smallStyled>
          ...
          <p>
            Когда делаешь канал два года, так или иначе методы работы с контентом оттачиваются сами собой, это такой опыт, данный в ощущениях, о нем трудно говорить внятно. Персональное медиа — очень индивидуализированная система, и здесь нельзя давать универсальные советы. Если вы человек с убедительным языком, харизматичным стилем и гибким мышлением, вам можно [почти] все. Если нет — тогда приходится помнить про пуш-уведомления, писать так, чтобы канал не мьютили, подстраиваться под читателя, разбавлять серьезный контент фаст-фудом или, наоборот, уделять больше времени отбору. Когда я заканчивал книжку <i>(выйдет в издательстве „АСТ“ в сентябре. — Прим. ред.)</i>, решил пролистать все свои посты с июля 2016-го. Занятие довольно мучительное, но четко прослеживаются две перемены: довольно радикальное изменение языка, а также шифт от описания спектаклей в сторону институциональной критики.
          </p>
          ...
          <H1Styled>«Между искусством и театром»</H1Styled>
          <H1smallStyled><a href="https://telegram.dog/bolotyanpishet/">t.me/bolotyanpishet</a></H1smallStyled>
          <Img
            noBorder
            sizes={data.img2.sizes}
            maxWidth="100%"
            desc="Yuumi Domoto, «Ikiru»" />

          <List>
            <li>
              <b>Автор: </b>Ильмира Болотян
           </li>
            <li>
              <b>Дата создания: </b>август 2017 года
           </li>
            <li>
              <b>Количество подписчиков: </b>960
          </li>
          </List>

          <H1smallStyled>«15 тысяч подписчиков канал о театре может собрать, если его вдруг решит вести Нагиев»</H1smallStyled>
          ...
          <H1Styled>«Немирович и Данченко»</H1Styled>
          <H1smallStyled><a href="https://telegram.dog/NemirovichandDanchenko/">t.me/NemirovichandDanchenko</a></H1smallStyled>
          <Img
            noBorder
            sizes={data.img3.sizes}
            maxWidth="100%"
            desc="Toshinobu Onosato, «Untitled»" />

          <List>
            <li>
              <b>Автор: </b>Евгений Зайцев
          </li>
            <li>
              <b>Дата создания: </b>октябрь 2017 года
          </li>
            <li>
              <b>Количество подписчиков: </b>1468
          </li>
          </List>

          <H1smallStyled>«Мы ж не космос собрались обогревать, а менять театральный мир»</H1smallStyled>
          ...
          <NoteWrapper>
            ...
            <p>
              В-третьих, мне не хватает свежих и радикально настроенных людей. Меня поразила ситуация в {" "}<NotedWord>„Институте театра“</NotedWord>, где люди моего возраста и чуть постарше сдавали в основном абсолютно конвенциональные тексты, просто сделанные чуть хуже, чем уже опубликованные в медиа. В-четвертых, текстов художников. В совриске под это есть целая рубрика в „ХЖ", про количество эссе Томаса Остермайера и других немцев я вообще молчу, у нас же это обычно неохотные интервью. Хочется теоретической рефлексии не со стороны, а изнутри процесса. В-пятых, не хватает совсем развлекательных форматов — вроде <a href="https://teatralium.com/articles/i_bratva_za_slova_otvechaet/">плейлистов на „Театралии“</a>. То есть рецензий и аналитических лонгридов для заполненности поля недостаточно».
          </p>
            <Note left top="160px">
          ...
          <H1Styled>«Воспитание вкуса»</H1Styled>
          <H1smallStyled><a href="https://telegram.dog/teatrvkus/">t.me/teatrvkus</a></H1smallStyled>
          <Img
            noBorder
            sizes={data.img5.sizes}
            maxWidth="100%"
            desc="Manika Nagare, «Cicada Chirps»" />
          ...
          <H1smallStyled>«Люди с хорошим вкусом не воюют и чуть меньше обманывают»</H1smallStyled>
          ...
          <p>Я не театральный критик и не журналист, я организатор, в основном я произвожу и продаю спектакли, а не осмысливаю их. Поэтому никакой регулярности постов у меня нет, и я к ней не стремлюсь. Когда выпускаешь спектакль, конечно, не успеваешь ни писать, ни смотреть что&#8209;либо еще. Ну и в целом я просто очень люблю делиться с людьми какими&#8209;то важными впечатлениями. То есть тем, что действительно важно увидеть, услышать, почувствовать или нужно знать, чтобы понимать, в каком мире живешь, чтобы не замыливался глаз, чтобы смотреть по сторонам, не закрываться. Ведь в идеале в театр нужно ходить именно за тем, что тебя хоть как&#8209;то поменяет. Так что единственный критерий моих несистемных постов — важность.
          </p>
          ...
          <H1Styled>«Пиши перформенс»</H1Styled>
          <H1smallStyled><a href="https://telegram.dog/pshperform/">t.me/pshperform</a></H1smallStyled>
          <Img
            noBorder
            sizes={data.img6.sizes}
            maxWidth="100%"
            desc="Hamada Kiyoshi, «15-E-16»" />

          <List>
            <li>
              <b>Автор: </b>Ваня Демидкин
           </li>
            <li>
              <b>Дата создания: </b>август 2017 года
            </li>
            <li>
              <b>Количество подписчиков: </b>584
            </li>
          </List>

          <H1smallStyled>«Текст остается обслуживающей театр инстанцией, неспособной на художественное высказывание»</H1smallStyled>
          ...
          <H1Styled>«посттравматический театр»</H1Styled>
          <H1smallStyled><a href="https://telegram.dog/theaterundtrauma/">t.me/theaterundtrauma</a></H1smallStyled>
          <Img
            noBorder
            sizes={data.img7.sizes}
            maxWidth="100%"
            desc="Lee Ufan, «From Line»" />

          <List>
            <li>
              <b>Автор:</b> Александра Воробьева
           </li>
            <li>
              <b>Дата создания:</b> январь 2017 года
            </li>
            <li>
              <b>Количество подписчиков: </b> 491
            </li>
          </List>

          <H1smallStyled>«Российскому театральному сообществу очень не хватает внутренней коммуникации»</H1smallStyled>
          ...
          <H1Styled>«Театр и академия»</H1Styled>
          <H1smallStyled><a href="https://telegram.dog/spectator_as_author/">t.me/spectator_as_author</a></H1smallStyled>
          <Img
            noBorder
            sizes={data.img8.sizes}
            maxWidth="100%"
            desc="Yamada Masaaki, «E. 279»" />

          <List>
            <li>
              <b>Автор:</b> Елена Гордиенко
           </li>
            <li>
              <b>Дата создания:</b> декабрь 2016 года
            </li>
            <li>
              <b>Количество подписчиков:</b> 598
            </li>
          </List>

          <H1smallStyled>«Я уже не понимаю, зачем что-то писать»</H1smallStyled>
...
export const pageQuery = graphql`
  query TelegramQuery {
    img1: imageSharp(id: { regex: "/telegram_kanaly/1.jpg/" }) {
      sizes(maxWidth: 1280) {
        ...GatsbyImageSharpSizes
      }
    }
    img2: imageSharp(id: { regex: "/telegram_kanaly/2.jpg/" }) {
      sizes(maxWidth: 1280) {
        ...GatsbyImageSharpSizes
      }
    }
    img3: imageSharp(id: { regex: "/telegram_kanaly/3.jpg/" }) {
      sizes(maxWidth: 1280) {
        ...GatsbyImageSharpSizes
      }
    }
    img4: imageSharp(id: { regex: "/telegram_kanaly/4.png/" }) {
      sizes(maxWidth: 1280) {
        ...GatsbyImageSharpSizes
      }
    }
    img5: imageSharp(id: { regex: "/telegram_kanaly/5.jpg/" }) {
      sizes(maxWidth: 1280) {
        ...GatsbyImageSharpSizes
      }
    }
    img6: imageSharp(id: { regex: "/telegram_kanaly/6.jpg/" }) {
      sizes(maxWidth: 1280) {
        ...GatsbyImageSharpSizes
      }
    }
    img7: imageSharp(id: { regex: "/telegram_kanaly/7.jpg/" }) {
      sizes(maxWidth: 1280) {
        ...GatsbyImageSharpSizes
      }
    }
    img8: imageSharp(id: { regex: "/telegram_kanaly/8.jpg/" }) {
      sizes(maxWidth: 1280) {
        ...GatsbyImageSharpSizes
      }
    }
    cover: imageSharp(id: { regex: "/telegram_kanaly/cover.jpg/" }) {
      sizes(maxWidth: 1280) {
        ...GatsbyImageSharpSizes
      }
    }
