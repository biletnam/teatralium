    ...
    return (
      <Wrapper>
        ...
        <Section>
          ...
          <Img marginTop="4rem" marginBottom="4rem" src={idavarp} desc="Юрий Анненков родился 11 (23) июля 1889 года в Петропавловске на севере Казахстана. В 1924-м выехал на выставку в Венецию и остался в Европе. Умер в Париже в 1974 году." />
          <H4>«Ленин топтал мои платья»</H4>
          ...
          <Note>Подробнее об истории создания костюма для Троцкого можно почитать в <a href="https://rg.ru/2017/10/31/rodina-kostum-trotskij.html">этой статье Ольги Хорошиловой</a>.</Note>
          ...
          <Img src="https://upload.wikimedia.org/wikipedia/commons/d/d2/Mandelstam%2C_Chukovsky%2C_Livshits_%26_Annenkov_1914_Karl_Bulla_%28with_smile%29.jpg" desc="Осип Мандельштам, Корней Чуковский, Бенедикт Лившиц и Юрий Анненков на фотографии Карла Буллы, 1914 год" />
